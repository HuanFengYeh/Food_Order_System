...
public class CaregoryAdaptor extends RecyclerView.Adapter<CaregoryAdaptor.ViewHolder> {
    ArrayList<CategoryDomain> categoryDomains;

    public CaregoryAdaptor(ArrayList<CategoryDomain> categoryDomains) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CaregoryAdaptor.ViewHolder holder, int position) {
